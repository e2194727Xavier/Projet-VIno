<div class="sticky bottom-0 w-full left-0 right-0 flex items-center ">
    <div class="justify-around flex w-full text-white bg-red-wine">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="32" class="w-10 h-10" viewBox="0 -960 960 960" width="32"><path d="M220-180h150v-250h220v250h150v-390L480-765 220-570v390Zm-60 60v-480l320-240 320 240v480H530v-250H430v250H160Zm320-353Z" fill="white"/></svg>
            <p class="text-xs">Acceuil</p>
        </a>
        <!-- ICÔNE WISHLIST -->
        ...
        <a href="/wishlist" class='hover:bg-pale-pink flex flex-col items-center p-2'>
            ...
            <!-- ICÔNE CELLIERS -->
            <!-- <button class="flex flex-col items-center p-2" wire:click="redirectToCellars"> -->
            <!-- BLANCHE -->

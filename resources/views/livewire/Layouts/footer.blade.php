<div class="sticky bottom-0 w-full left-0 right-0 flex items-center">
    <div class="justify-around flex w-full text-white bg-red-wine py-2">
        ...
        <button class='hover:bg-pale-pink flex flex-col items-center  px-2 w-1/3' wire:click="redirectToWishlist">
            ...
            <div class="text-xs w-100 break-words pt-2">Catalogue des bouteilles</div>
            <!-- </a> -->
        </button>
        <!-- ICÔNE WISHLIST -->
        <!-- <button class='hover:bg-pale-pink flex flex-col items-center p-2' wire:click="redirectToWishlist"> -->
            ...
            <!-- <svg viewBox="-10 0 90 67.5" class="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- ICÔNE CELLIERS -->
        <button class="flex flex-col items-center px-2 w-1/3 " wire:click="redirectToCellars">
            <!-- BLANCHE -->
            ...
            <div class="text-xs w-100 break-words pt-2">Vos Celliers</div>
            <!-- </a> -->
        </button>
        ...
        <button class='hover:bg-pale-pink flex flex-col items-center px-2 w-1/3 ' wire:click="redirectToAddBottle">
            ...
            <div class="text-xs w-100 break-words pt-2">Ajouter une bouteille</div>
            <!-- </a> -->
        </button>
    </div>
</div>